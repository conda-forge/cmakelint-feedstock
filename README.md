...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cmakelint-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9286&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cmakelint-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cmakelint` can be installed with:

```
conda install cmakelint
```

It is possible to list all of the versions of `cmakelint` available on your platform with:
